...
class CrmClientsPage extends Page implements HasTable
{
    use InteractsWithTable;

    protected static string $view = 'filament.pages.crm-clients-page';

    protected static ?string $title = 'Clientes CRM';
    protected static ?string $navigationLabel = 'Clientes';
    protected static ?string $navigationGroup = 'CRM';
    protected static ?string $navigationIcon = 'heroicon-o-users';
    protected static ?int $navigationSort = 2;
    protected static ?string $slug = 'crm-clientes';
    ...
    public function exportCsv(): StreamedResponse
    {
        return response()->streamDownload(function (): void {
            ...
            $this->crmQuery()->orderBy('users.id')->chunk(500, function ($records) use ($h) {
