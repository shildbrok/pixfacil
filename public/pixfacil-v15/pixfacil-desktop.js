...
function boot(){mountShell();document.addEventListener('keydown',e=>{if((e.ctrlKey||e.metaKey)&&e.key.toLowerCase()==='k'&&!AUTH()&&!BLOCKED()){e.preventDefault();document.getElementById('pfd-search-input')?.focus()}});addEventListener('resize',mountShell,{passive:true})}
