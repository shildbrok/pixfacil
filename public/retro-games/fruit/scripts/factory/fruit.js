...
var infos = {
    boom: {
        info: [ "images/fruit/boom.png", 66, 68, 26, 0, 0, null ],
    },
    peach: {
        info: [ "images/fruit/peach.png", 62, 59, 37, -50, 0, "#e6c731" ],
    },
    sandia: {
        info: [ "images/fruit/sandia.png", 98, 85, 38, -100, 0, "#c00" ],
    },
    apple: {
        info: [ "images/fruit/apple.png", 66, 66, 31, -54, 0, "#c8e925" ],
    },
    banana: {
        info: [ "images/fruit/banana.png", 126, 50, 43, 90, 0, null ],
    },
    basaha: {
        info: [ "images/fruit/basaha.png", 68, 72, 32, -135, 0, "#c00" ],
    },
    dragon: {
        info: [ "images/fruit/dragon.png", 0, 0, 0, 0, 0, null ],
    }
};
...
exports.create = function( type, originX, originY, isHide, flameStart ){
	...
	var fruit = new ClassFruit({ type: type, originX: originX, originY: originY, flameStart: flameStart, value: fruitValue }).set( isHide );
