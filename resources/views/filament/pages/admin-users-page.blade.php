    ...
    <div class="users-wrap">
        <section class="users-card">
            ...
            <div class="users-stats">
                <div class="users-stat"><span>Total</span><strong>{{ $stats['total'] }}</strong><small>Usuários</small></div>
                <div class="users-stat"><span>Depositantes</span><strong>{{ $stats['depositors'] }}</strong><small>Com depósito pago</small></div>
                <div class="users-stat"><span>Apostadores</span><strong>{{ $stats['bettors'] }}</strong><small>Com apostas</small></div>
                <div class="users-stat"><span>Influencers</span><strong>{{ $stats['influencers'] }}</strong><small>Modo publicidade</small></div>
                <div class="users-stat"><span>Saldo players</span><strong style="font-size:13px">R$ {{ number_format($stats['wallet_total'], 2, ',', '.') }}</strong><small>Carteiras</small></div>
                <div class="users-stat"><span>Depositado</span><strong style="font-size:13px">R$ {{ number_format($stats['total_deposited'], 2, ',', '.') }}</strong><small>Total pago</small></div>
            </div>
        </section>
