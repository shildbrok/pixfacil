<x-filament::page>
    ...
    <div class="crm-wrap">
        <section class="crm-card">
            <div class="crm-hero">
                <h2 class="crm-title">Apostadores CRM</h2>
                <p class="crm-sub">Página dedicada somente a jogadores que apostaram, com foco em volume, perdas, ganhos, perfil e resultado da casa.</p>
            </div>
        </section>
