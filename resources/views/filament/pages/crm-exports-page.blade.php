<x-filament::page>
    ...
    <div class="crm-wrap">
        <section class="crm-card">
            <div class="crm-hero">
                <h2 class="crm-title">Exportações CRM</h2>
                <p class="crm-sub">Central para exportar dados completos de clientes: CPF, nome, telefone, e-mail, total apostado, total depositado, total ganho e total perda.</p>
            </div>
            <div class="crm-actions">
                <x-filament::button wire:click="exportAllClients" icon="heroicon-o-arrow-down-tray" color="success">Exportar base completa de clientes</x-filament::button>
            </div>
        </section>
    </div>
</x-filament::page>
