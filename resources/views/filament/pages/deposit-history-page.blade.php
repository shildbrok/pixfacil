<x-filament::page>
    ...
    <div class="hist-wrap">
        <section class="hist-card">
            <div class="hist-hero">
                <h2 class="hist-title">Histórico de Depósitos</h2>
                <p class="hist-sub">Consulte, filtre e limpe registros de depósitos. A página antiga de Depósitos foi movida para a seção de históricos.</p>
            </div>
