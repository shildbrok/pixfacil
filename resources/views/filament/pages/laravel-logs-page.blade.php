                ...
                <div class="og-hero-inner">
                    ...
                    <div class="og-stats">
                        <div class="og-stat">
                            ...
                            <div class="og-stat-value">{{ $file ?: 'laravel.log' }}</div>
                        </div>
                        <div class="og-stat">
                            <div class="og-stat-label">Tamanho</div>
                            <div class="og-stat-value">{{ $this->selectedFileSize }}</div>
                        </div>
                        <div class="og-stat">
                            <div class="og-stat-label">Erros filtrados</div>
                            <div class="og-stat-value">{{ $errorCount }}</div>
                        </div>
                        <div class="og-stat">
                            <div class="og-stat-label">Avisos filtrados</div>
                            <div class="og-stat-value">{{ $warningCount }}</div>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section class="og-panel">
                ...
                <div class="og-list">
                    @forelse ($rows as $row)
                        ...
                        <article class="og-event {{ $levelClass($row['level']) }}">
                            <div class="og-event-top">
                                <div class="og-event-main">
                                    ...
                                    <div>
                                        <h3 class="og-event-title">{{ $row['label'] }}</h3>
                                        <p class="og-event-hint">{{ $row['hint'] }}</p>
                                    </div>
                                </div>

                                <div class="og-badges">
                                    <span class="og-badge {{ $levelBadgeClass($row['level']) }}">{{ $row['level'] }}</span>
                                    @if ($gateway)
                                        <span class="og-badge og-badge-gateway">{{ $gateway }}</span>
                                    @endif
                                </div>
                            </div>
