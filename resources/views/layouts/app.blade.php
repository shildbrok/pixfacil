...
<head>
    ...
    <link rel="manifest" href="{{ asset('pixfacil-v15/manifest.webmanifest') }}?v=20260904-1531">
    ...
    <link rel="apple-touch-icon" sizes="192x192" href="{{ asset('pixfacil-v15/icons/icon-192.png') }}">
    ...
    @if (config('services.meta_capi.pixel_id'))
        <script>
            window.META_PIXEL_ID = "{{ config('services.meta_capi.pixel_id') }}";
        </script>
    @endif
    ...
    {{-- PixFácil V15: Arcade Experience, identidade, som opcional e PWA instalável. --}}
    @php
    ...
    <script>
        ...
        window.PIXFACIL_V15_SERVER_OWNED = @json((bool) $pf9OwnedRoute);
        window.PIXFACIL_V13_GAME_ROUTE = @json((bool) $pf13GameRoute);
    </script>
    <link rel="stylesheet" href="{{ asset('pixfacil-v15/pixfacil-v15.css') }}?v=20260904-1531">
    <script defer src="{{ asset('pixfacil-v15/pixfacil-v15.js') }}?v=20260904-1531"></script>

</head>

<body color-theme="dark" class="bg-base{{ $pf9OwnedRoute ? ' pf15-owned-server' : '' }}{{ $pf13GameRoute ? ' pf13-player-server' : '' }}">
