...
<?php $component->withAttributes([]); ?>
    ...
    <div class="pf-wrap">
        <section class="pf-card">
            ...
            <div class="pf-stats">
                <div class="pf-stat"><span>Carteiras</span><strong><?php echo e($stats['count']); ?></strong><small>PlayFiver</small></div>
                <div class="pf-stat"><span>Saldo total</span><strong><?php echo e($this->money($stats['total'])); ?></strong><small>Todas as carteiras</small></div>
                <div class="pf-stat"><span>Operacional</span><strong><?php echo e($this->money($stats['operational'])); ?></strong><small>info_only = não</small></div>
                <div class="pf-stat"><span>Informativo</span><strong><?php echo e($this->money($stats['informative'])); ?></strong><small>info_only = sim</small></div>
                <div class="pf-stat <?php echo e($stats['primary_blocking'] ? 'danger' : ''); ?>"><span>Principal</span><strong><?php echo e($this->money($stats['primary_balance'])); ?></strong><small><?php echo e($stats['primary_name']); ?></small></div>
                <div class="pf-stat"><span>Abaixo alerta</span><strong><?php echo e($stats['below_notify']); ?></strong><small>Notificação ativa</small></div>
                <div class="pf-stat"><span>Com erro</span><strong><?php echo e($stats['with_error']); ?></strong><small>Último erro registrado</small></div>
                <div class="pf-stat"><span>Última sync</span><strong style="font-size:12px"><?php echo e($stats['last_sync'] ? \Carbon\Carbon::parse($stats['last_sync'])->format('d/m/Y H:i') : '-'); ?></strong><small>PlayFiver</small></div>
            </div>
        </section>
...
<?php endif; ?><?php /**PATH /home/u187586491/domains/pixfacil.fun/public_html/resources/views/filament/pages/admin-aggregator-wallets-page.blade.php ENDPATH**/ ?>