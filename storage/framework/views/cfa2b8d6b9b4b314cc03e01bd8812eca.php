    ...
    <div class="ga-wrap">
        <section class="ga-card">
            ...
            <div class="ga-stats">
                <div class="ga-stat">
                    <span>Status</span>
                    <strong><i class="ga-dot <?php echo e($stats['configured'] ? 'ga-ok' : 'ga-bad'); ?>"></i><?php echo e($stats['configured'] ? 'Configurado' : 'Incompleto'); ?></strong>
                    <small>Código, token e secret</small>
                </div>

                <div class="ga-stat"><span>API Base</span><strong style="font-size:12px"><?php echo e($stats['api_url']); ?></strong><small>PlayFiver endpoint</small></div>
                <div class="ga-stat"><span>Provedores</span><strong><?php echo e($stats['providers']); ?></strong><small>No catálogo local</small></div>
                <div class="ga-stat"><span>Jogos</span><strong><?php echo e($stats['games']); ?></strong><small>No catálogo local</small></div>
                <div class="ga-stat"><span>Última edição</span><strong style="font-size:12px"><?php echo e($stats['last_update'] ? \Carbon\Carbon::parse($stats['last_update'])->format('d/m/Y H:i') : '-'); ?></strong><small>games_keys.updated_at</small></div>
            </div>
        </section>
        ...
        <section class="ga-card ga-form">
            ...
            <div style="padding:16px 12px 10px;display:flex;justify-content:flex-end;border-top:1px solid rgba(163, 163, 163,.14);margin-top:12px">
                <?php echo e($this->saveAggregatorAction); ?>
...
<?php endif; ?>
<?php /**PATH /home/u187586491/domains/pixfacil.fun/public_html/resources/views/filament/pages/admin-game-aggregator-page.blade.php ENDPATH**/ ?>