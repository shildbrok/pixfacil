    ...
    <div class="og-wrap">
        ...
        <div class="og-grid two" style="padding:0">
            <section class="og-card og-section">
                ...
                <div class="og-links">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $this->projectLinks(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a class="og-link" href="<?php echo e($link['url']); ?>" target="_blank" rel="noopener noreferrer">
                            <div>
                                <strong><?php echo e($link['label']); ?></strong>
                                <small><?php echo e($link['description']); ?></small>
                            </div>
                            <em>Abrir</em>
                        </a>
...
<?php endif; ?>
<?php /**PATH /home/u187586491/domains/pixfacil.fun/public_html/resources/views/filament/pages/dashboard-admin.blade.php ENDPATH**/ ?>